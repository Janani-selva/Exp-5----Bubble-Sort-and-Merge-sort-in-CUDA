...
## OUTPUT:
<img width="1138" height="515" alt="image" src="https://github.com/user-attachments/assets/be62f361-acfa-457c-b4ac-0a0d813ea0ff" />


## RESULT:
Thus, the program has been executed using CUDA to perform and compare CPU and GPU based sorting algorithms (Bubble Sort and Merge Sort) and analyze their execution time performance.
